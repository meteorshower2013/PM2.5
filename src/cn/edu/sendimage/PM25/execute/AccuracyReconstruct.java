...
public class AccuracyReconstruct {
	private static final Logger logger = LogManager.getLogger("AccuracyReconstruct.class");
	...
	private static String[] getParams(String name) throws SAXException, IOException, ParserConfigurationException {
		...
		Map<String, String> reconstructedParams = xml.getAccuracyReconstructParams();
		...
		params[2] = reconstructedParams.get("reconstructedList_input")+name+"_reconstruction"+".tif";
